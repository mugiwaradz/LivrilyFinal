...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img alt="livrily" src="Livrily.png" width="30" height="30"> </a>
    </div>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          ...
          <p>Livirily vos offre plusiurs catégorie des produits pour bien enrichire votre veux.</p>
        </div>      
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          ...
          <p>tu peut maintent prand une panier et faire un shopping dans nos supermarché.!</p>
        </div>      
      </div>
    </div>
...
<div> <a href="https://www.instagram.com/zshockisme/"> <img width="80" height="80" alt="img" src="fb.png"> </a> </div>
  <ul class="list-unstyled mb-0">
                <li><i class="fas fa-map-marker-alt fa-2x"></i>
                    <p>contact@https://www.instagram.com/livrily</p>
                </li>
                <li><i class="fas fa-phone mt-4 fa-2x"></i>
                    <p>+ 213 672 28 83 29 </p>
                </li>
                <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                    <p>Constantine, elkhroub 25100, ALG </p>
                </li>
            </ul>
</footer>
