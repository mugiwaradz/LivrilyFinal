...
<div class="container">
	<form:form method="post" commandName="article">
		...
		<fieldset class="form-group">
			<form:label path="Referance">Referance</form:label>
		...
		<fieldset class="form-group">
			<form:label path="quantitequantitequantite">quantite</form:label>
			<form:input path="quantitequantite" type="text" class="form-control"
				required="required" />
